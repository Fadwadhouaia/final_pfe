  ...
  <div>
    <a-layout id="components-layout-demo-side" style="min-height: 100vh">
      <a-layout-sider v-model="collapsed" collapsible theme="light">
        <div class="logo" <img class="orange-logo" src="../static/assets/Orange_logo.svg" alt="" />
        <a-menu theme="light" :default-selected-keys="['Overview']" mode="inline">
          ...
          <a-sub-menu key="Distribution">
            <span slot="title"><a-icon type="container" /><span>Distribution</span></span>
      ...
      <a-layout>
        ...
        <a-layout-content style="margin: 10px 45px">
          <a-breadcrumb style="margin: 15px 0px 27px 51px">
            ...
            <a-breadcrumb-item v-if="this.$route.name == 'teamTest___fr'"> Distribution </a-breadcrumb-item>
            <a-breadcrumb-item v-if="this.$route.name == 'teamTest___fr'"> Groups </a-breadcrumb-item>
